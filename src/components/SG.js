...
function SG() {
  ...
  return (
    ...
    className="CS_SG_HeaderImage__img"/>
      ...
      <div className="CS_SG_Description_Section5">
        ...
        The project’s ambitious goal was to create a <span class="CS_SG_BodyText_Highlight"> scalable, adaptable solution</span> for government offices—one that could enhance service delivery while <span class="CS_SG_BodyText_Highlight"> reducing workload</span>, all <span class="CS_SG_BodyText_Highlight"> without disrupting their existing work patterns and standards.</span>
        </p>
        <p className='CS_SG_BodyText'>
        As part of the startup and UX designer, I led a comprehensive research journey to uncover the core challenges faced by government employees. Through user interviews, observations, and workflow analyses, several key issues surfaced: <span class="CS_SG_BodyText_Highlight"> A vast number of files and documents are difficult to organize and search, resulting in inefficiencies caused by manual processes, insufficient bandwidth to handle heavy workloads, and fragmented communication channels, among other issues.
        </span>
        </p>
      </div>
    ...
    <div className="CS_SG_Section8_HeaderImage">  
    <img
    src={`${process.env.PUBLIC_URL}/Group134-2.png`}
    alt="Description of Image"
    className="CS_SG_Section8_HeaderImage__img"/>
      </div>


      {/* Section 7 : Query from officers Image*/}
      <div className='CS_SG_SectionOfficerQuery_background'>
      </div>

      <div className='CS_SG_SectionOfficerQuery_Image'>
        <img
      ...
      <div className='CS_SG_Section7_Text_Left'>
        ...
        <div className='CS_SG_Section7_Text_Right'>
            <p>It is a <span class="CS_SG_BodyText_Highlight"> Non-linear, Iterative Approach</span> that helps improve the product. We develop the product in two phases. In the first phase, we deploy some functionality on a pilot basis. The second phase involves delivering a partial solution. For both phases, we used the same process, as outlined below.
            In the following diagram, my roles and responsibilities are highlighted in green text.
            </p>
      </div> 

      <div className="CS_SG_Section7_HeaderImage">
       <img
    src={`${process.env.PUBLIC_URL}/UX_Process.png`}
    alt="Description of Image"
    className="CS_SG_Section7_HeaderImage__img"/>
      </div>



      {/* Section 9: Key Insights from research */}
      <div className='CS_SG_Section6_background'>
      </div>

      <div className='CS_SG_Section6_Text'>
        <p className='CS_SG_Section6_Header'>A Key Insight emerged during Research</p>
            <p>Nearly every government office relied heavily on an <span class="CS_SG_BodyText_Highlight"> Inward-Outward notebook.</span> This notebook is essentially a simple log where a person short note about incoming and outgoing letters, including who they are from and to whom they are addressed. This physical logbook served as a <span class="CS_SG_BodyText_Highlight"> critical backbone</span> for their operations. Recognizing its importance, I made it the <span class="CS_SG_BodyText_Highlight"> cornerstone of Design Strategy.</span>
            </p>
            </div>
    ...
    Impact of Phase 1
      ...
      <div className="CS_SG_Description_Section10">
         We <span class="CS_SG_BodyText_Highlight"> deployed Phase 1 of the product on a pilot basis</span> in some offices. Below are the key screens and the impact of our solution.
      </div>
    ...
    <div className='CS_SG_image1_Description '>
    ...
    alt="Description of Image"
    className="CS_SG_Section13_HeaderImage__img"/>
      </div>
    ...
    <p className='CS_SG_info_Description'>I also enhance and categorize physical file colors. This approach allows employees to identify the type of file just by its color from a distance. For example, in the following image, yellow indicates student-related files, while pink represents election-related files. Additionally, the solution reflects these color codes in the software system, enabling the admin to customize the colors as needed. This approach <span class="CS_SG_BodyText_Highlight">not only reduces the cost of traditional file but also eliminates the need for barcode stickers.</span> Instead, the system directly prints the barcode and other details on the front page of the file. This results in both <span class="CS_SG_BodyText_Highlight">cost reduction and improved efficiency </span> in locating multiple files
    </p>
    </div>
    ...
    alt="Description of Image"
    className="CS_SG_Section14_HeaderImage__img"/>
      </div>


   {/* Section 15 : rack image  */}
   <div className="CS_SG_Section15_HeaderImage">  
    <div className='CS_SG_image2_Description '>
    <p>📌 Introduced a Rack System that informs users about the  physical location of files and documents in the office.
    </p>
    <p className='CS_SG_info_Description'>    This system provides details about the status of physical files and their placement. I wore multiple hats in this project. Alongside working as a UX designer, I also contributed as a UX engineer and product strategist. Initially, developers faced challenges in implementing the system without using physical sensors to track the location of files. However, I <span class="CS_SG_BodyText_Highlight">supported the developers by designing the logic and creating pseudocode, enabling the functionality to identify which file is placed in which section without relying on sensors.</span>
</p>
    ...
    alt="Description of Image"
    className="CS_SG_Section15_HeaderImage__img"/>
  </div>
    


       {/* Section 16 : Forgot Password  */}
   <div className="CS_SG_Section16_HeaderImage">  
    <div className='CS_SG_image2_Description '>
    <p>📌 Reset Password Using OTP Without Internet Access on the User's Computer
    </p>
    <p className='CS_SG_info_Description'> 
    ...
    alt="Description of Image"
    className="CS_SG_Section16_HeaderImage__img"/>
  </div>
    
  
   {/* Section 17 : answer from officers Image*/}
  <div className='CS_SG_SectionOfficerAnswer_background'>
  </div>

  <div className='CS_SG_SectionOfficerAnswer_Image'>
  <img
  ...
  <div className="CS_SG_Header_Section18">
    Issues in Phase 1
  </div>

  <div className="CS_SG_Description_Section18">
      there are  <span class="CS_SG_BodyText_Highlight"> some issue we found</span> after implementation of phase 1. which required the focus in phase 2 implementation. 
  </div>


  {/* Section 19 : Problem 1  */}
  <div className="CS_SG_Section19_HeaderImage">  
  <div className='CS_SG_image2_Description '>
  <p>📌 Some application and file flows are missing.
  </p>
  <p className='CS_SG_info_Description'> 
  The application requires an inward entry for processing outward tasks. When an outward task is marked as complete, it relies on the corresponding inward entry. Using this approach, we can calculate the percentage of completion. In <span class="CS_SG_BodyText_Highlight"> most cases (around 80% - 90%), this workflow operates as expected</span>. However, there are some exceptions where the are doing manual work becuase system not addressing it directly.
  </p>
  <p className='CS_SG_info_Description'>
...
Some inward entries require multiple outward tasks. However, the system currently marks the inward as "completed" after a single outward task is completed, even though additional outward tasks may still be pending. 
  ...
  <div className="CS_SG_Section20_HeaderImage">
       <img
    src={`${process.env.PUBLIC_URL}/Issue1.png`}
    alt="Description of Image"
    className="CS_SG_Section20_HeaderImage__img"/>
  </div>


  {/* Section 21 : Problem 2  text */}
  <div className="CS_SG_Section21_HeaderImage">  
  <div className='CS_SG_image2_Description '>
  ...
  {/* <div className="CS_SG_Section22_HeaderImage">
       <img
    src={`${process.env.PUBLIC_URL}/UX_Process.png`}
    alt="Description of Image"
    className="CS_SG_Section22_HeaderImage__img"/>
  </div> */}


  {/* Section 23 : Problem 3  text */}
  <div className="CS_SG_Section23_HeaderImage">  
  <div className='CS_SG_image2_Description '>
  ...
  {/* <div className="CS_SG_Section24_HeaderImage">
       <img
    src={`${process.env.PUBLIC_URL}/UX_Process.png`}
    alt="Description of Image"
    className="CS_SG_Section24_HeaderImage__img"/>
  </div> */}

{/* Section 25 : Key Insights from research */}
<div className='CS_SG_Section25_background'>
      </div>

      <div className='CS_SG_Section25_Text'>
        <p className='CS_SG_Section25_Header'></p>
        <p>
...
<div className="CS_SG_Header_Section26">
    Phase 2 Highlishts
  </div>

  <div className="CS_SG_Description_Section26">
  ...
  <div className="CS_SG_Section27_HeaderImage">  
  <div className='CS_SG_image2_Description '>
  <p>📌 Flow Chart
  </p>
  <p className='CS_SG_info_Description'>  
  ...
  <div className="CS_SG_Section28_HeaderImage">
       <img
    src={`${process.env.PUBLIC_URL}/FlowChart.jpg`}
    alt="Description of Image"
    className="CS_SG_Section28_HeaderImage__img"/>
  </div>



  {/* Section 29 : Problem 2 text  */}
  {/* <div className="CS_SG_Section29_HeaderImage">  
  <div className='CS_SG_image2_Description '>
 ...
 */}
  ...
  {/* <div className="CS_SG_Section30_HeaderImage">
       <img
    src={`${process.env.PUBLIC_URL}/U.png`}
    alt="Description of Image"
    className="CS_SG_Section30_HeaderImage__img"/>
  </div>

 */}

  {/* Section 31 : wireframe text  */}
  <div className="CS_SG_Section31_HeaderImage">  
  <div className='CS_SG_image2_Description '>
  <p>📌 wireframes 
  </p>
  <p className='CS_SG_info_Description'> 
  ...
  <div className="CS_SG_Section32_HeaderImage">
       <img
    src={`${process.env.PUBLIC_URL}/Wireframe 1.png`}
    alt="Description of Image"
    className="CS_SG_Section32_HeaderImage__img"/>
  </div>

  {/* Section 33 : wireframe  image 2 */}
  <div className="CS_SG_Section33_HeaderImage">
       <img
    src={`${process.env.PUBLIC_URL}/Wireframe 2.png`}
    alt="Description of Image"
    className="CS_SG_Section33_HeaderImage__img"/>
  </div>

  {/* Section 34 : wireframe  image 3 */}
  <div className="CS_SG_Section34_HeaderImage">
       <img
  ...
  <div className="CS_SG_Section35_HeaderImage">
       <img
  ...
  <div className="CS_SG_Section36_HeaderImage">
       <img
  ...
  <div className="CS_SG_Section37_HeaderImage">
       <img
  ...
  <div className="CS_SG_Section38_HeaderImage">
       <img
