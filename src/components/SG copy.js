...
function SG() {
  ...
  return (
    <div className="CS_SG_container">
      ...
      From concept to productization, I successfully completed the product design in a very short period. The client, who owned a regional newspaper, wanted a mobile app for their publication within a tight timeline. </div>
